...
@MapperScan(basePackages = {"com.testspotifyapi.www.repository"})
@ComponentScan(basePackages = {"com.testspotifyapi.www.service", "com.testspotifyapi.www.exception"})
...
public class RootConfig {
	...
	public DataSource dataSource() {
		...
		hikariConfig.setJdbcUrl("jdbc:log4jdbc:mysql://localhost:3306/testspotifyapidb");
		hikariConfig.setUsername("testspotifyUser");
		hikariConfig.setPassword("spotify");
